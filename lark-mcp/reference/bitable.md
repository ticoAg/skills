...
```yaml
工具: mcp__lark__bitable_v1_app_create
data:
...
```yaml
工具: mcp__lark__bitable_v1_appTable_create
path:
...
```yaml
工具: mcp__lark__bitable_v1_appTableRecord_search
path:
...
```yaml
工具: mcp__lark__bitable_v1_appTableRecord_create
path:
  app_token: "bascnxxxxxx"  # 需要替换为实际的 app_token
...
```yaml
工具: mcp__lark__bitable_v1_appTableRecord_update
path:
  app_token: "bascnxxxxxx"  # 需要替换为实际的 app_token
  table_id: "tblxxxxxx"     # 需要替换为实际的 table_id
...
```yaml
工具: mcp__lark__bitable_v1_appTableField_list
path:
  app_token: "bascnxxxxxx"  # 需要替换为实际的 app_token
  table_id: "tblxxxxxx"     # 需要替换为实际的 table_id
params:
